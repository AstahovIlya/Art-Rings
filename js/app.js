(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".new-product__slider") && window.innerWidth >= 768) new swiper_core_Swiper(".new-product__slider", {
        ...
        if (document.querySelector(".slider-preview")) {
            let sliderPrev = new swiper_core_Swiper(".slider-preview", {
            ...
            new swiper_core_Swiper(".slider-main", {
                modules: [ Navigation, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".slider-feedback") && window.innerWidth >= 768) new swiper_core_Swiper(".slider-feedback", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (document.querySelector(".galari-article__slider") && window.innerWidth >= 768) new swiper_core_Swiper(".galari-article__slider", {
            modules: [ Navigation, Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    let searchButtonDel = document.querySelector(".search__button-del");
    let itemTags = document.querySelectorAll("#item-tag");
    let buttonFilter = document.querySelector(".catalog-header__button-filter");
    let exitFilter = document.querySelector(".filter__close");
    ...
    searchButtonDel.addEventListener("click", (function() {
        searchInput.value = "";
        searchInput.focus();
    }));
    for (let item of itemTags) item.addEventListener("click", (function() {
        item.classList.toggle("item-tag-active");
    }));
    if (document.querySelector(".catalog-header__button-filter")) {
    ...
    if (document.querySelector(".rating-feedback")) {
        const rating = document.querySelector(".rating-feedback");
        const stars = rating.querySelectorAll("._icon-star");
        const inputs = rating.querySelectorAll(".rating-feedback__item");
        for (let i = 0; i < inputs.length; i++) inputs[i].addEventListener("click", (function() {
            stars.forEach((function(star, index) {
                if (index <= i) star.classList.add("_active"); else star.classList.remove("_active");
            }));
        }));
    }
    window["FLS"] = true;
